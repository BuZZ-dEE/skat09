...
/**
 * The skat table window.
 * 
 * @since 21.07.2015 20:57:31
 * 
 * @author Sebastian Schlatow <ssc@openmailbox.org>
 *
 */
public class GameTableStage extends Stage {
		...
		/**
		 * Das Pane, das die Karten der Gegner darstellt
		 */
		private Pane gegnerHand;
		/**
		 * Pane, auf dem die momentan gespielten Karten dargestellt werden
		 */
		private Pane aufTisch;
		/**
		 * Pane, auf dem die Karten des menschlichen Spielers dargestellt werden
		 */
		private Pane aufHand;

		/**
		 * Punkte-Pane auf der rechen Seite
		 */
		private Pane rechteSeite;
		/**
		 * Status-Pane auf der linken Seite
		 */
		private Pane linkeSeite;
		/**
		 * markiert die gew&auml;hlte Karte
		 */
		private Label gewaehlt;
		 ...
		 */
		private TricksStage stichfenster;
		 ...
		 */
		public GameTableStage(Table tisch, GUIOutput ausgabe) {

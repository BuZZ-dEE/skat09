...
public class ControllerTest {
	...
	public void alleinspielerAktionenTest() {
		...
		for (int i = 0; i < 10; i++) {
			mensch.getBlatt().add(new PlayingCard(Suit.ACORNS, Value.BUBE));
		}
		...
		skat[1] = new PlayingCard(Suit.HEARTS, Value.SECHS);
		skat[2] = new PlayingCard(Suit.LEAVES, Value.DAME);
	...
	public void auswertungTest() {
		...
		blatt1.add(new PlayingCard(Suit.ACORNS, Value.BUBE));
		blatt1.add(new PlayingCard(Suit.ACORNS, Value.ASS));
		blatt1.add(new PlayingCard(Suit.ACORNS, Value.ZEHN));
		blatt1.add(new PlayingCard(Suit.ACORNS, Value.DAME));
		blatt1.add(new PlayingCard(Suit.ACORNS, Value.KOENIG));
		blatt1.add(new PlayingCard(Suit.BELLS, Value.ASS));
		blatt1.add(new PlayingCard(Suit.BELLS, Value.ZEHN));
		blatt1.add(new PlayingCard(Suit.LEAVES, Value.ASS));
		blatt1.add(new PlayingCard(Suit.LEAVES, Value.ZEHN));
		...
		blatt2.add(new PlayingCard(Suit.LEAVES, Value.NEUN));
		blatt2.add(new PlayingCard(Suit.LEAVES, Value.SECHS));
		blatt2.add(new PlayingCard(Suit.LEAVES, Value.ZEHN));
		blatt2.add(new PlayingCard(Suit.LEAVES, Value.DAME));
		spieler2.setStiche(blatt2);
		
		ArrayList<PlayingCard> blatt3 = new ArrayList<PlayingCard>(); 
		blatt3.add(new PlayingCard(Suit.HEARTS, Value.NEUN));
		blatt3.add(new PlayingCard(Suit.HEARTS, Value.ACHT));
		blatt3.add(new PlayingCard(Suit.HEARTS, Value.ZEHN));
		blatt3.add(new PlayingCard(Suit.HEARTS, Value.SIEBEN));
	...
	public void aufrauemenTest() {
		...
		skatkarten[0] = new PlayingCard(Suit.HEARTS, Value.BUBE);
	...
	public void stichAuswertungTest() {
		...
		PlayingCard k1 = new PlayingCard(Suit.HEARTS, Value.BUBE);
		PlayingCard k2 = new PlayingCard(Suit.HEARTS, Value.ASS);
		PlayingCard k3 = new PlayingCard(Suit.BELLS, Value.SIEBEN);
	...
	public void schlauerSpielerInitTest() {
		...
		PlayingCard[] skat = new PlayingCard[3];
		skat[0] = new PlayingCard(Suit.HEARTS, Value.ACHT);
		skat[1] = new PlayingCard(Suit.LEAVES, Value.ASS);
		skat[2] = new PlayingCard(Suit.ACORNS, Value.DAME);
		tisch.setSkat(skat);
